...
All new code should import directly from loop_core.vendor.langextract.core.exceptions.
"""
# pylint: disable=duplicate-code

from __future__ import annotations

from loop_core.vendor.langextract.core import exceptions as core_exceptions
