...
from loop_core.vendor.langextract.core import schema
from loop_core.vendor.langextract.core import types as core_types
from loop_core.vendor.langextract.providers import patterns
from loop_core.vendor.langextract.providers import router
from loop_core.vendor.langextract.providers import schemas
...
class GeminiLanguageModel(base_model.BaseLanguageModel):  # pylint: disable=too-many-instance-attributes
  ...
  def __init__(
    ...
    # Batch processing removed (requires google-cloud-storage)
